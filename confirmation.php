...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $conn->prepare("INSERT INTO confirmation_tbl 
        (firstname, lastname, suffix, birthdate, birthplace, book_no, page_no)
        VALUES (?, ?, ?, ?, ?, ?, ?)");

    $stmt->bind_param("sssssss", $firstname, $lastname, $suffix, $birthdate, $birthplace, $book_no, $page_no);
...
<div class="container mt-5">
    <h2 class="text-center mb-4">Confirmation Record Form</h2>
